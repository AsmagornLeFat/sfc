// ==UserScript==
// @name         Starfleet Commander Galaxy Scan Comparison (v2.7)
...
(function() {
    ...
    console.log("SFCScript: Script for Galaxy Scan loaded (v2.7).");
    ...
    // New, more aggressive observer to handle dynamic page changes
        ...
        for(const mutation of mutationsList) {
            if (mutation.type === 'childList') {
                if (document.getElementById('galaxy') && document.getElementById('solar_system')) {
                    addFloatingPanel();
                    observer.disconnect(); // Stop observing once the panel is added
                    console.log("SFCScript: DOM elements found and observer disconnected.");
                    break;
                }
            }
        }
    ...
    // Also try to add the panel immediately in case the elements are already present
    if (document.getElementById('galaxy') && document.getElementById('solar_system')) {
        addFloatingPanel();
    }
})();
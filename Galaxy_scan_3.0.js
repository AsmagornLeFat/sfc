// ==UserScript==
// @name         Starfleet Commander Galaxy Scan Comparison (v3.0)
...
(function() {
    ...
    console.log("SFCScript: Galaxy Scan Comparison loaded (v3.0).");
                ...
                if (levelCell && fleetNameElement && playerElement && planetLink) {
                    ...
                    if (isDifficultyValid && isNameValid) {
                        ...
                        if (planet && !isNaN(planet)) {
                            const npcKey = `${galaxy}:${system}:${planet}_${fleetName}_${finalDifficulty}`;
                            npcData[npcKey] = {
                                name: fleetName,

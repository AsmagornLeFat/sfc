// ==UserScript==
// @name         Starfleet Commander Galaxy Scan Comparison (v5.1)
...
(function() {
    ...
    console.log("SFCScript: Galaxy Scan Comparison loaded (v5.1).");
    ...
    function scrapeNpcData() {
        try {
            ...
            const npcData = {};
            // Select all fleet rows that are either NPC fleets, Player fleets with an NPC, or a fleet row with the new NPC class.
            const fleetRows = document.querySelectorAll('.fleet_row.npc_fleet, .fleet_row.player_fleet:has(.npc), .fleet_row.npc');

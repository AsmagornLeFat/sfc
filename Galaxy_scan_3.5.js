// ==UserScript==
// @name         Starfleet Commander Galaxy Scan Comparison (v3.5)
...
(function() {
    ...
    console.log("SFCScript: Galaxy Scan Comparison loaded (v3.5).");
                ...
                if (levelCell && fleetNameElement && playerElement && planetLink) {
                    ...
                    if (isDifficultyValid && isNameValid) {
                        ...
                        if (planet && !isNaN(planet)) {
                            // The storage key no longer depends on difficulty

// ==UserScript==
// @name         Starfleet Commander Galaxy Scan Comparison (v4.9)
...
(function() {
    ...
    console.log("SFCScript: Galaxy Scan Comparison loaded (v4.9).");
    ...
    function scrapeNpcData() {
        try {
            ...
            const npcData = {};
            // Select all fleet rows that are either NPC fleets or Player fleets with an NPC.
            const fleetRows = document.querySelectorAll('.fleet_row.npc_fleet, .fleet_row.player_fleet:has(.npc)');

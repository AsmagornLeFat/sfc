// ==UserScript==
// @name         Starfleet Commander Galaxy Scan Comparison (v5.0)
...
(function() {
    ...
    console.log("SFCScript: Galaxy Scan Comparison loaded (v5.0).");
        ...
        try {
            ...
            fleetRows.forEach(row => {
                ...
                if (levelCell && fleetNameElement && planetLink) {
                    const difficultyColor = playerElement ? playerElement.getAttribute('data-color') : 'easy';
                    let finalDifficulty;

// ==UserScript==
// @name          AddResTotal
// @namespace     https://www.eljercode.com
// @description   Add Resources Total to Fleets Page, as well as the number of cargo ships to transport all resources
// @include       https://*starfleet*.com/fleet*
// @include       https://*starfleet*.com/buildings/shipyard*
// @include       https://*starfleet*.com/galaxy/show*
// @include       https://*starfleet*.com/messages*
// @include       https://*stardrift*.com/fleet*
// @include       https://*stardrift*.com/buildings/shipyard*
// @include       https://*stardrift*.com/galaxy/show*
// @include       https://*stardrift*.com/messages*
// @version       2.5
// ==/UserScript==
...
// document.getElementById('resources_table').appendChild(vClearDiv);
 ...
 if(vStardrift) {
  ...
  newDiv.innerHTML+='Carm : <span id="vCarmCount">0</span>';
 }
 newPDiv.appendChild(newDiv);
 document.getElementById('resources_table').appendChild(newPDiv);
...
function GetTop(ele) {
//https://morecavalier.com/index.php?whom=Code+Snippet+Library%2FJavaScript%2FGetLeft+and+GetTop
	if (ele.offsetParent) {
...
function addNewStyle(newStyle) {
 //https://stackoverflow.com/questions/462537/
...
function fUpdateTotals() {
 ...
 vCarmCount=(Math.ceil(vTotal / 125000)).toLocaleString("fr-FR");
 ...
 if(document.getElementById('vCarmCount')) document.getElementById('vCarmCount').innerHTML=vCarmCount;
 if(document.getElementById('vHercCount')) document.getElementById('vHercCount').innerHTML=vHercCount;
 if(document.getElementById('vAtlasCount')) document.getElementById('vAtlasCount').innerHTML=vAtlasCount;
}
...
function fCheckCargoInput() {
 ...
 if(!vStardrift) {
  ...
  //document.getElementById('moreCarms').innerHTML=Math.ceil(vNeededCargo/125000);
    // Format numbers using .toLocaleString("fr-FR")
  //document.getElementById('neededCarms').innerHTML = parseInt(vCarmanorNeeded).toLocaleString("fr-FR");
  document.getElementById('moreCarms').innerHTML = Math.ceil(vNeededCargo / 125000).toLocaleString("fr-FR");
  if(vNovaTourney) {
